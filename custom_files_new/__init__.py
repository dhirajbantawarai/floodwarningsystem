...
_datasetZooRegistry.register_dataset_class("camels_gb_v2", CamelsGBV2)
_datasetZooRegistry.register_dataset_class("camels_gbv2", CamelsGBV2)
_datasetZooRegistry.register_dataset_class("camelsgbv2", CamelsGBV2)